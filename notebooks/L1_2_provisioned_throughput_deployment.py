...
spark.sql(  # noqa: F821
    f"DROP TABLE IF EXISTS {catalog}.{schema}.provisioned_throughput_monitoring_payload"
)
...
response = client.chat.completions.create(
    ...
    messages=[
        {"role": "system", "content": "You are a helpful AI assistant."},
        {
            "role": "user",
            "content": (
                "Give me a recipe for something i can cook"
                " with these ingredients: Quinoa, lentils,"
                " sweet potato, chickpeas, oats."
                " It should be one dish, not a menu."
            ),
        },
    ],
    max_tokens=500,
