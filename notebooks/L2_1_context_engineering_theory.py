...
# MAGIC
# MAGIC **Context Engineering** is the practice of providing
# MAGIC relevant information to LLMs to improve their responses.
# MAGIC
...
def rewrite_query(original_query: str) -> list[str]:
    ...
    prompt = (
        "Given this search query, generate 3 alternative "
        "phrasings that would help retrieve relevant "
        "information:\n\n"
...
def create_rag_prompt(query: str, context_chunks: list[str]) -> str:
    ...
    prompt = (
        ...
        "question. If the answer is not in the context, "
