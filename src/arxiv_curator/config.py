...
class ProjectConfig(BaseModel):
    ...
    llm_endpoint: str | None = Field(None, description="LLM endpoint name")
    embedding_endpoint: str | None = Field(None, description="Embedding endpoint name")
    warehouse_id: str | None = Field(None, description="Warehouse ID")
    vector_search_endpoint: str | None = Field(
        None, description="Vector search endpoint name"
    )
    genie_space_id: str | None = Field(
        None,
        description="Genie space ID for MCP integration",
    )
